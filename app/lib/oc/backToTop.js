...
function backtotop() {
    ...
    function template() {
        return [
            ...
            '<a href="#" title="{{hovertext}}" ng-style="myStyles" style="margin-right: 10px; margin-bottom: 60px; position: fixed; bottom: 30px; right: 30px; display: inline-block;" class="scrollToTop"><i class="fa  fa-chevron-up fa-3x text-info"></i></a>'
        ].join('');
    }
}